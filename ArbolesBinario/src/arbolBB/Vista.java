...
public class Vista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jInternalFrame2.setBounds(0, 10, 780, 320);
        ...
        botonResetear.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(botonResetear, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(botonEliminar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(botonResetear, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void InOrdenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InOrdenActionPerformed
        ...
        String resultado = this.simulador.inOrden();
        this.impresion.setText("Recorrido InOrden: " + resultado);
        this.repintarArbol();
    }//GEN-LAST:event_InOrdenActionPerformed

    private void PreOrdenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PreOrdenActionPerformed
        // TODO add your handling code here:
        String resultado = this.simulador.preOrden();
        this.impresion.setText("Recorrido PreOrden: " + resultado);
        this.repintarArbol();
    ...
    private void PostOrdenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PostOrdenActionPerformed
        // TODO add your handling code here:
        String resultado = this.simulador.postOrden();
        this.impresion.setText("Recorrido PostOrden: " + resultado);
        this.repintarArbol();
    ...
    private void botonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarActionPerformed
        ...
        try {
            int dato = Integer.parseInt(txtdato.getText());
            System.out.println("Intentando eliminar el dato: " + dato);
            boolean resultado = this.simulador.eliminar(dato);
            if (resultado) {
                System.out.println("El dato fue eliminado: " + dato);
                JOptionPane.showMessageDialog(null, "El dato fue eliminado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                complementos();
            } else {
                System.out.println("El dato no se encontró en el árbol: " + dato);
                JOptionPane.showMessageDialog(null, "El dato no existe en el árbol", "Error", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void botonResetearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonResetearActionPerformed
        // TODO add your handling code here:
        this.simulador.resetear();
        this.inicializar(false);
        this.txtdato.setText("");
        this.impresion.setText("");
        complementos();
        JOptionPane.showMessageDialog(null, "El árbol ha sido reseteado", "Reseteo completo", 1);
    ...
    private void repintarArbol() {
        ...
        this.jInternalFrame2.revalidate();
